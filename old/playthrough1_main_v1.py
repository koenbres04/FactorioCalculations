...
from iron_factory import add_iron_factory
from copper_factory import add_copper_factory
...
def main():
    ...
    iron_factory_output, iron_ore_line = add_iron_factory(
        factory,
        num_drills=96,
    ...
    copper_factory_output = add_copper_factory(
        factory,
        num_drills=50,
        drill_bonus=resource_bonus,
    ...
    chemical_output = add_chemical_factory(
        factory, iron_factory_output, copper_factory_output,
    ...
    circuit_factory_output = add_circuit_factory(
        factory, iron_factory_output, copper_factory_output, chemical_output,
        crafter_level=2,
        output_caps={
            "circuit": 15,
        },
    ...
    factory.connect(iron_factory_output, main_belt, "iron_plate", "gear", "iron_stick", "steel")
    factory.connect(copper_factory_output, main_belt, "copper_plate")
